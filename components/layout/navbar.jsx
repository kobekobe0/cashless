...
const Navbar = () => {
    return (
        <div className="bg-[#100389] text-white w-full py-5 fixed top-0 left-0 flex items-center justify-between px-6 z-50">
            ...
            {/* PLACEHOLDER NO NAVIGATION OR LOGIC YET: Check Payment Status */}
